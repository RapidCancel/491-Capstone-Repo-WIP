...
class LoginScreen(QWidget):
    ...
    def __init__(self, caseCode):
        ...
        self.setWindowTitle(self.caseParameters()[0])
        self.DBManager = DatabaseManager(self.caseParameters()[1])
    ...
    def loginCheck(self):       # Retrieve parameters from DB file
        ...
        passwordHash = self.DBManager.fetchValue("SELECT hashedPassword FROM users WHERE username = ?", (usernameInput,))
